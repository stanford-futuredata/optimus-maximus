...
INTERPOLATION_MODELS = [
    ('KDD-100-reg-1-0.1-items', (100, 1000990, 62496, (512, 1024))),
    ('KDD-100-reg-1-0.1-users', (100, 100099, 624961, (256, 512))),
    ('KDD-100-reg-1-0.2-items', (100, 1000990, 124992, (512, 1024))),
    ('KDD-100-reg-1-0.2-users', (100, 200198, 624961, (256, 512))),
    ('KDD-100-reg-1-0.3-items', (100, 1000990, 187488, (512, 1024))),
    ('KDD-100-reg-1-0.3-users', (100, 300297, 624961, (256, 512))),
    ('KDD-100-reg-1-0.4-items', (100, 1000990, 249984, (512, 1024))),
    ('KDD-100-reg-1-0.4-users', (100, 400396, 624961, (256, 512))),
    ('KDD-100-reg-1-0.5-items', (100, 1000990, 312480, (512, 1024))),
    ('KDD-100-reg-1-0.5-users', (100, 500495, 624961, (256, 512))),
    ('KDD-100-reg-1-0.6-items', (100, 1000990, 374976, (512, 1024))),
    ('KDD-100-reg-1-0.6-users', (100, 600594, 624961, (512, 1024))),
    ('KDD-100-reg-1-0.7-items', (100, 1000990, 437472, (512, 1024))),
    ('KDD-100-reg-1-0.7-users', (100, 700693, 624961, (512, 1024))),
    ('KDD-100-reg-1-0.8-items', (100, 1000990, 499968, (512, 1024))),
    ('KDD-100-reg-1-0.9-items', (100, 1000990, 562464, (512, 1024))),
    ('KDD-100-reg-1-0.9-users', (100, 900891, 624961, (512, 1024))),
]
