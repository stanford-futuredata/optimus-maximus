...
LEMP_MODELS = LEMP_NETFLIX_MODELS + [
    ('lemp-paper/KDD-50', (51, 1000990, 624961, (512, 1024)), YAHOO_KDD_DATASET),
]
...
NOMAD_R2_MODELS = [
    ...
    ('nomad/R2-10-reg-0.001', (10, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
    ('nomad/R2-10-reg-0.0001', (10, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
    ...
    ('nomad/R2-25-reg-0.001', (25, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
    ('nomad/R2-25-reg-0.0001', (25, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
    ...
    ('nomad/R2-50-reg-0.001', (50, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
    ('nomad/R2-50-reg-0.0001', (50, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
    ...
    ('nomad/R2-100-reg-0.001', (100, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
    ('nomad/R2-100-reg-0.0001', (100, 1823179, 136736, (1024, 2048)),
     YAHOO_R2_DATASET),
]
