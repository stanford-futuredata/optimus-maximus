...
./nomad_train_netflix.sh 0.05 100 ~/data/netflix_prize_dataset/nomad-format ~/models/nomad/Netflix-100-reg-0.05
...
./nomad_train.sh 1 100 ~/data/yahoo_KDD_cup_2011_dataset/nomad-format ~/models/nomad/KDD-100-reg-1
