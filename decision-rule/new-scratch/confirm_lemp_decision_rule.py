...
for _, row in lemp_dec_rule.iterrows():
    ...
    num_sample_users = row['num_users']
    ...
    overhead_rt = blocked_mm_sample_time * num_sample_users if row[
        'lemp_wins'] else lemp_index_time + lemp_preproc_time + lemp_sample_time * num_sample_users
...
print('Percent Overhead Avg/Std Dev/Max',
